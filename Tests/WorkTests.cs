...
namespace Tests
{
    ...
    public class WorkTests
    {
        ...
        public void WorkWithImageFileAndWrongKeyTest()
        {
            ...
            var encryptedFile = Cryptor.EncryptFileWithStream(keyPair, testKeyPair.PublicKey, RAW_FILE, OUTPUT_DIRECTORY, ".test", true);
            Console.Write("Decrypting testfile . . .\n");
            //try to decrypt with an wrong key
            var decryptedFile = Cryptor.DecryptFileWithStream(keyPair, Path.Combine(OUTPUT_DIRECTORY, encryptedFile), OUTPUT_DIRECTORY);
        ...
        public void WorkWithImageFileTest()
        {
            ...
            var keyPair = new KeyPair(Utilities.HexToBinary(PUBLIC_KEY), Utilities.HexToBinary(PRIVATE_KEY));
            Console.Write("Encrypting testfile . . .\n");
            var encryptedFile = Cryptor.EncryptFileWithStream(keyPair, Utilities.HexToBinary(PUBLIC_KEY), RAW_FILE, OUTPUT_DIRECTORY, ".test", true);
            Console.Write("Decrypting testfile . . .\n");
            var decryptedFile = Cryptor.DecryptFileWithStream(keyPair, Path.Combine(OUTPUT_DIRECTORY, encryptedFile), OUTPUT_DIRECTORY);
            Console.Write("Get checksum of testfiles . . .\n");
            Assert.AreEqual(StreamCryptor.Helper.Utils.GetChecksum(RAW_FILE), StreamCryptor.Helper.Utils.GetChecksum(Path.Combine(OUTPUT_DIRECTORY, decryptedFile)));
        ...
        public void WorkWithVerySmallFileTest()
        {
            ...
            fs.Close();
            Console.Write("Encrypting testfile . . .\n");
            var encryptedFile = Cryptor.EncryptFileWithStream(keyPair, TESTFILE_RAW, null);
            Console.Write("Decrypting testfile . . .\n");
            Cryptor.DecryptFileWithStream(keyPair, Path.Combine(OUTPUT_DIRECTORY, encryptedFile), TESTFILE_DECRYPTED_OUTPUT_DIRECTORY);
            Console.Write("Get checksum of testfiles . . .\n");
